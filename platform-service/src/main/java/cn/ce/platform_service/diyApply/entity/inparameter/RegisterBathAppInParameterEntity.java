 ...
 * @date dat2017年10月14日 time下午3:58:37
 *
 **/
public class RegisterBathAppInParameterEntity {

	private String appId;//应用appId   选填,注册已经存在的应用
	...
	private String appCode;//app code     必填 此参数为 应用库对应关系不可重复 
