...
public class MongoFiledConstants {
	...
	public static final String BASIC_CREATEDATE = "createDate";
	
	public static final String BASIC_USERID = "userId";
	...
	public static final String DIY_APPLY_APPLYKEY = "applyKey";
