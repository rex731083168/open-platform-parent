...
public class UserController {
	...
	public Result<Page<User>> approveUsers(String roleType, String userName,
			String checkState, String state, int currentPage, int pageSize) {

		return userService.approveUsers(roleType,userName,checkState,state,currentPage,pageSize);
	}
